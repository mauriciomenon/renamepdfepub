"""Legacy: moved to `legacy/Teste_APIs_ISBN.py`.

This stub keeps a small footprint so linters and tests focus on the
maintained modules. The original full script is preserved under
`legacy/Teste_APIs_ISBN.py`.
"""

from pathlib import Path

ORIGINAL = Path(__file__).with_name('legacy').joinpath('Teste_APIs_ISBN.py')

if __name__ == '__main__':
    print(f"This file was moved to {ORIGINAL}")
